(function() {
  ...
  /*  eql asserts that the target is deeply equal to the given obj
      eg. Target array is deeply (but not strictly) equal to [1, 2]
    ...
    describe('indexOf', function() {
      ...
      it('returns the first index that the target can be found at when there are multiple matches', function() {
        var numbers = [10, 22, 22, 30, 22];
        expect(_.indexOf(numbers, 22)).to.equal(1);
      });
    });
    ...
    describe('reduce', function() {
      ...
      it('should accept falsy value as memo', function() {
        var result = _.reduce([1, 2, 3], function(memo, item) {
          return memo * item;
        }, 0);
